...
#define T3MATH_PI_DIV2 1.570796326794896615f
#define T3MATH_2PI     6.28318530717958646f

#define T3MATH_INV_PI  0.31830988618379067154f
#define T3MATH_INV_2PI 0.15915494309189533577f
#define T3MATH_INV_4PI 0.07957747154594766788f
